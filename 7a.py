#Esta versión es incorrecta, pensaba que el operador || tenía preferencia sobre los otros. La solución está en la 7b
...
def is_calibrated(value,operands):
	...
	for c in combs:
		...
		new_operands,new_combs = reduce_operands(operands,c)
		print("NCOM:"+str(new_combs))
		print("NOPE:"+str(new_operands))
		total = apply_comb(new_operands,new_combs)
		print("---")
		print("Total" +str(total))
